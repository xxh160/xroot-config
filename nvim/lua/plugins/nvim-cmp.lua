...
if not status_lspkind then
	vim.notify("No lspkind")
	return
end

cmp.setup({
    snippet = {
        -- Select the vsnip engine here. You can switch to another engine.
	...
	formatting = {
		...
		format = lspkind.cmp_format({
			...
			mode = "symbol_text",
			-- Prevent the popup from
            -- showing more than provided characters (e.g 50 will not show more than 50 characters)
			maxwidth = 100,
